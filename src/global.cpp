...
bool              Global::hand_launch_mode = false;
bool              Global::realtime_throttle = true;
uint32_t          Global::rng_seed = 0;
float             Global::duration_sec = 0.0f;
uint16_t          Global::command_port = 0;
bool              Global::hand_launch_thrown = false;
double            Global::hand_launch_velocity_rel = 0.0;
double            Global::hand_launch_phi = 0.0;
double            Global::hand_launch_theta = 0.0;
double            Global::hand_launch_psi = 0.0;
double            Global::hand_launch_posX = 0.0;
double            Global::hand_launch_posY = 0.0;
double            Global::hand_launch_altitude = 0.0;
double            Global::hand_launch_dZRot = 0.0;
double            Global::hand_launch_throw_velocity_mps = 0.0;
